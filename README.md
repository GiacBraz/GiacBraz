...
Beyond my core work in Business Intelligence, I act as an *AI Product Creator*, independently designing and managing end-to-end web applications by orchestrating advanced AI agents and Large Language Models.
...
- **AI-Assisted Dev:** Prompt Engineering, AI Agent Orchestration (Antigravity), LLM Integration via API (Claude Function Calling).
- **Tech Stack (Architected & Managed):** Python (Streamlit), JavaScript/TypeScript (React, Next.js), Supabase, SQLite, Vercel, Git/GitHub.
...
An application designed to automate complex commercial quotes from text-based catalogs.
...
## Methodology Note
For all my personal projects, code development, local testing, version control (Git branching), and cloud deployment (Vercel) were executed and optimized by **coordinating, prompt-engineering, and instructing advanced AI agents**.
